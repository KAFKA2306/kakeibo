...
RAKUTEN_JP_SPEC = BrowserAdapterSpec(
    ...
    notes=(
        "Verified 2026-08-10 rendered capture: 127/127 records across six pages (25+25+25+25+25+2), PASS.",
        "Verified rendered page exposes order date, order number, shop, order-detail link, items and amounts.",
        "Use the semantic order-detail anchor as the record locator, then climb to the smallest ancestor containing exactly one order link plus 注文日/注文番号; hashed CSS-module class names are not a contract.",
        ...
        "Verified pagination controls are buttons; the final page has disabled next navigation.",
